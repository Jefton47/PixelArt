...
S_brushSize = Button(880, 305, 10,20, (240,240,240), "Размер кисти", 2)
S_eraserSize = Button(880, 225, 10,20, (240,240,240), "Размер ластика", 2)
...
while True:
    ...
    screen.blit(colorTitleFont.render("Инструменты", True, (50,50,50)), (779, 30))
